...
CFG_CFLAGS_x86_64-linux-dios := -m64
CFG_GCCISH_CFLAGS_x86_64-linux-dios := -Wall -Werror -g -fPIC -m64
CFG_GCCISH_CXXFLAGS_x86_64-linux-dios := -fno-rtti
CFG_GCCISH_LINK_FLAGS_x86_64-linux-dios := -shared -fPIC -ldl -pthread  -lrt -g -m64
...
CFG_LINUXY_x86_64-linux-dios := 1
...
CFG_LINUXY_x86_64-apple-darwin :=
...
CFG_LINUXY_arm-linux-androideabi := 1
...
CFG_LINUXY_arm-unknown-linux-gnueabihf := 1
...
CFG_LINUXY_arm-unknown-linux-gnueabi := 1
...
CFG_LINUXY_mips-unknown-linux-gnu := 1
...
CFG_LINUXY_x86_64-unknown-dragonfly := 1
