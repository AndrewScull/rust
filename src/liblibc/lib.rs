...
#[cfg(not(dios))] pub use types::os::common::posix01::*;
#[cfg(not(dios))] pub use types::os::common::bsd44::*;
pub use types::os::arch::c95::*;
pub use types::os::arch::c99::*;
#[cfg(not(dios))] pub use types::os::arch::posix88::*;
#[cfg(not(dios))] pub use types::os::arch::posix01::*;
...
#[cfg(not(dios))] pub use funcs::posix88::fcntl::*;
#[cfg(not(dios))] pub use funcs::posix88::stat_::*;
#[cfg(not(dios))] pub use funcs::posix88::stdio::*;
#[cfg(not(dios))] pub use funcs::posix88::unistd::*;

#[cfg(not(dios))] pub use funcs::bsd43::*;
